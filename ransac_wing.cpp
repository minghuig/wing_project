 ...
 * 
 * Description: Get n random points from observation set to build a model plane
 *     from
 * 
 * Parameters:
 *     maybeInliers: The resulting set of n randomly selected points from the
 *         observation set
 *     numMaybeInliers: the number of random points to select
